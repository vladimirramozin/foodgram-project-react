   ...
   # parser_classes = (MultiPartParser, FormParser)
    ...
    def download_shopping_cart(self, request):
        ...
        for obj in shopping_cart:
            ...
            if result_cart[name_ingredient.ingredient.name].exists():
                result_cart[name_ingredient.ingredient.name]+=recipe.ingredients.amount
            result_cart[name_ingredient.ingredient.name]=recipe.ingredients.amount, name_ingredient.measurement_unit        
